...
%Calculamos la distancia del punto de origen al setpoint
d = sqrt((hxd-x1(1))^2+(hyd-y1(1))^2);
%Acotamos acorde a la distancia del putno 
d_limit = 10;
%Valor con el que saturaremos las velocidades
k_max = 0.35; 

%Para distancias cortas
if d < d_limit
    k = d*.1; 
else %Para distancias largas
    k = d*.05; 
end
